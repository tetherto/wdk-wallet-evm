...
| Example | Description |
|---------|-------------|
| [Create Wallet](https://github.com/tetherto/wdk-examples/blob/main/evm/01-create-wallet.ts) | Initialize a wallet manager and derive accounts from a seed phrase |
| [Manage Accounts](https://github.com/tetherto/wdk-examples/blob/main/evm/02-manage-accounts.ts) | Work with multiple accounts and custom derivation paths |
| [Check Balances](https://github.com/tetherto/wdk-examples/blob/main/evm/03-check-balances.ts) | Query native token and ERC-20 balances for owned accounts |
| [Read-Only Account](https://github.com/tetherto/wdk-examples/blob/main/evm/04-read-only-account.ts) | Monitor balances for any address without a private key |
| [Send Transaction](https://github.com/tetherto/wdk-examples/blob/main/evm/05-send-transaction.ts) | Estimate fees and send native token transactions (EIP-1559 + legacy) |
| [Token Transfer](https://github.com/tetherto/wdk-examples/blob/main/evm/06-token-transfer.ts) | Transfer ERC-20 tokens and estimate transfer fees |
| [Sign & Verify Message](https://github.com/tetherto/wdk-examples/blob/main/evm/07-sign-verify-message.ts) | Sign messages and verify signatures |
| [Fee Management](https://github.com/tetherto/wdk-examples/blob/main/evm/08-fee-management.ts) | Retrieve current network fee rates |
| [Memory Management](https://github.com/tetherto/wdk-examples/blob/main/evm/09-memory-management.ts) | Securely dispose wallets and clear private keys from memory |
