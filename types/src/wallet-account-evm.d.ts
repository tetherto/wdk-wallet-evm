...
export default class WalletAccountEvm
  extends WalletAccountReadOnlyEvm
  implements IWalletAccount
{
  /**
...
export type EvmTransaction =
  import("./wallet-account-read-only-evm.js").EvmTransaction;
export type EvmTransferOptions =
  import("./wallet-account-read-only-evm.js").EvmTransferOptions;
export type EvmWalletConfig =
  import("./wallet-account-read-only-evm.js").EvmWalletConfig;
